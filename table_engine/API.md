...
| `compute_ast_hash()` | [`te_direct_db.py`](table_engine/te_direct_db.py) | Computes deterministic 32-byte binary SHA-256 hash for join graphs and column filters to deduplicate relational views. |
